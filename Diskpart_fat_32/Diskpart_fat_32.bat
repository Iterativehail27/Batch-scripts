...
:F
(echo "You are going to format disk %input% to fat 32 32GB size if you've made a mistake press 'n' now" [y:n])
set /p choice1= 
if "%choice1%" == "Y" goto A
if "%choice1%" == "y" goto A
...
echo clean 
echo create part primary size=32000
echo format fs=fat32 quick) | diskpart
